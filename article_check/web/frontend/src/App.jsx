        ...
        <div className="flex items-center justify-between border-b border-white/10 px-6 py-5">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-slate-400">Academic Review Workspace</div>
            </div>
          </Link>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-4">
            ...
            {status?.ai_provider && (
              <div className="mt-2 text-xs text-slate-500">
                AI Provider: {String(status.ai_provider).toUpperCase()}
              </div>
            )}
          </div>
        </div>
        ...
        <div className="mt-auto px-4 pb-5 pt-6">
          <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-primary-500/20 to-sky-500/10 px-4 py-4">
            ...
            <div className="mt-3 space-y-2 text-xs text-slate-300">
              <div className="flex items-center gap-2"><Activity className="h-3.5 w-3.5" /> 格式预警与定位</div>
              <div className="flex items-center gap-2"><Activity className="h-3.5 w-3.5" /> 文献有效性核验</div>
              <div className="flex items-center gap-2"><Activity className="h-3.5 w-3.5" /> 审改建议与正式报告</div>
            </div>
          </div>
        </div>
      </aside>
        ...
        <header className="app-topbar">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs uppercase tracking-[0.28em] text-slate-500">Academic Intelligence Layer</div>
                <div className="mt-1 text-lg font-semibold text-slate-900">论文审查与文献核验系统</div>
              </div>
            </div>
